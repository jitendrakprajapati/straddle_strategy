...
class pykite:
    ...
    def profile(self):
        ...
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.user_profile}", headers=self.get_header()
        ).json()
        return response
    ...
    def margins(self, segment=None):
        ...
        if segment:
            response = self.__session.get(
                f"{self.__root_url}{self.__urls.user_margins_segment.format(segment=segment)}",
                headers=self.get_header(),
            ).json()
        else:
            response = self.__session.get(
                f"{self.__root_url}{self.__urls.user_margins}",
                headers=self.get_header(),
            ).json()
        return response
    ...
    def orders(self):
        ...
        """
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.orders}", headers=self.get_header()
        ).json()
        return response
    ...
    def trades(self):
        ...
        """
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.trades}", headers=self.get_header()
        ).json()
        return response
    ...
    def positions(self):
        ...
        """
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.portfolio_positions}",
            headers=self.get_header(),
        ).json()
        return response
    ...
    def holdings(self):
        ...
        """
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.portfolio_holdings}",
            headers=self.get_header(),
        ).json()
        return response
    ...
    def order_history(self, order_id):
        ...
        """
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.order_info.format(order_id=order_id)}",
            headers=self.get_header(),
        ).json()
        return response
    ...
    def order_trades(self, order_id):
        ...
        """
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.order_trades.format(order_id=order_id)}",
            headers=self.get_header(),
        ).json()
        return response
    ...
    def place_order(
        ...
        response = self.__session.post(
            f"{self.__root_url}{self.__urls.order_place.format(variety = variety)}",
            data=params,
            headers=self.get_header(),
        ).json()
        return response
    ...
    def modify_order(
        ...
        response = self.__session.put(
            f"{self.__root_url}{self.__urls.order_modify.format(variety = variety, order_id=order_id)}",
            data=params,
            headers=self.get_header(),
        ).json()
    ...
    def cancel_order(self, variety, order_id, parent_order_id=None):
        ...
        response = self.__session.delete(
            f"{self.__root_url}{self.__urls.order_cancel.format(variety = variety, order_id=order_id)}",
            data=params,
            headers=self.get_header(),
        ).json()
        return response["message"]
    ...
    def convert_position(
        ...
        """Modify an open position's product type."""
        response = self.__session.put(
            f"{self.__root_url}{self.__urls.portfolio_positions_convert}",
            params=params,
            headers=self.get_header(),
        ).json()
        return response["message"]
    ...
    def quotes(self, instruments):
        ...
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.market_quote}",
            params={"i": ins},
            headers=self.get_header(),
        ).json()
    ...
    def ohlc(self, instruments):
        ...
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.market_quote_ohlc}",
            params={"i": ins},
            headers=self.get_header(),
        ).json()
        return response["data"]
    ...
    def ltp(self, instruments):
        ...
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.market_quote_ltp}",
            params={"i": ins},
            headers=self.get_header(),
        ).json()
        return response["data"]
    ...
    def order_margins(self, list_of_orders):
        ...
        """
        response = self.__session.post(
            f"{self.__root_url}{self.__urls.order_margins}",
            data=json.dumps(list_of_orders),
            headers=self.get_header(),
        )
        return response
    ...
    def basket_order_margins(self, list_of_orders, consider_positions=True, mode=None):
        ...
        response = self.__session.post(
            f"{self.__root_url}{self.__urls.order_margins_basket}",
            data=json.dumps(list_of_orders),
            params=params,
            headers=self.get_header(),
        )
    ...
    def historical_data(
        ...
        response = self.__session.get(
            f"{self.__root_url}{self.__urls.market_historical.format(instrument_token=instrument_token, interval=interval)}",
            params=params,
            headers=self.get_header(),
        ).json()
        return response
    ...
    def pnl(self):
        ...
        return {
            "net": {
                "realised": net_realised,
                "unrealised": net_unrealised,
                "total": net_total,
            },
            "day": {
                "realised": day_realised,
                "unrealised": day_unrealised,
                "total": day_total,
            },
        }
